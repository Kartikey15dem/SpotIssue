...
class ProfileRepositoryImpl(
    ...
    override suspend fun getProfile(userId: String?): Result<org.example.project.profile.domain.models.Profile> {
    ...
    override suspend fun updateProfile(profile: org.example.project.profile.domain.models.Profile): Result<org.example.project.profile.domain.models.Profile> {
        return try {
    ...
    override suspend fun refreshProfile(userId: String?): Result<org.example.project.profile.domain.models.Profile> {
    ...
    override suspend fun getUserPosts(userId: String?): Result<List<org.example.project.home.domain.models.Post>> {
        // Try cache first
    ...
    override suspend fun addPostToCache(post: org.example.project.home.domain.models.Post) {
    ...
    override suspend fun getLikedPostsFromCache(sort: Sort): List<org.example.project.home.domain.models.Post> {
        return localDataSource.getCachedLikedPosts(sort)
    }

    override suspend fun fetchAndCacheLikedPosts(userId: String?): Result<List<org.example.project.home.domain.models.Post>> {
    ...
    override suspend fun getLikedPosts(userId: String?): Result<List<org.example.project.home.domain.models.Post>> {
        // Try cache first
    ...
    override suspend fun addLikedPostToCache(post: org.example.project.home.domain.models.Post) {
    ...
    private fun ProfileEntity.toProfile(): org.example.project.profile.domain.models.Profile {
        return Profile(
            imageUrl = imageUrl ?: "",
            name = name,
    ...
    private fun org.example.project.profile.domain.models.Profile.toEntity(): ProfileEntity {
